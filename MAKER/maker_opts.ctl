...
genome=Calosphaeria_pulchella.fasta #genome sequence (fasta file or fasta embeded in GFF3 file)
...
protein=peps.cdhit  #protein sequence file in fasta format (i.e. from mutiple oransisms)
...
#-----Gene Prediction
snaphmm=Calosphaeria_pulchella.snap_intronlen.hmm #SNAP HMM file
gmhmm=Calosphaeria_pulchella.gmes.mod #GeneMark HMM file
augustus_species=Calosphaeria_pulchella_CEGMA_CRF #Augustus gene prediction species model
